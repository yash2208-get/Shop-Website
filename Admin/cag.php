  ...
  <span  onclick="openNav()">&#9776; </span>
    ...
    <div class="container-fluid">
        <div class="text-center">
            <h1 class=" text-capitalize display-5">Catagragy Add</h1>
          ...
          <div class="col-md-10 col-10 col-xxl-4 mx-auto bcol">
            <form class="row g-3" method="post">
              ...
              <div class="col-md-6">
                ...
                <input type="text" class="form-control"  id="inputPassword4" name="dis">
              </div>
              <div class="col-12">
                <button type="submit" name="b1" class="btn btn-primary cen" id="add">Catagragy Add</button>
              </div>
            </form>
          </div>
        </div>
      ...
      <div class="container">
        <div class="row gy-2 my-5">
          ...
          if(isset($_POST["b1"]))
          {
            $cname=$_POST["name"];
            $dis=$_POST["dis"];
            $sql = "INSERT INTO cagy (name,dis) VALUES ( '$cname', '$dis')";
